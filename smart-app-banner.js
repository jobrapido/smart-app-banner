        ...
        if (this.options.force) {
          ...
          if (userAgent.match(/Safari/i) !== null ||
            (userAgent.match(/CriOS/i) !== null ||
              Number(userAgent.substr(userAgent.indexOf('OS ') + 3, 3)
                .replace('_', '.')) < 6)) {
            this.type = 'ios';
      ...
      SmartBanner.prototype = {
        ...
        create: function () {
          ...
          if (doc.querySelector('.body-wrapper')) {
            doc.querySelector('.body-wrapper')
              .appendChild(sb);
          ...
          q('.smartbanner-button', sb)
            .addEventListener('click', this.install.bind(this), false);
          q('.smartbanner-close', sb)
